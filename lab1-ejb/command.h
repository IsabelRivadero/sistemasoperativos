...
/*
 * Copia de un comando de un scommand, con los mismos comandos o argumentos.
 * Returns: Array con el comando, argumentos si los tiene y un ultimo elemento NULL, 
 *  dejando el Array listo para ser ejecutado por execvp().
 * Ensures: scommand_is_empty (result)
 */  
